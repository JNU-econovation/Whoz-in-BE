...
import com.whoz_in.main_api.command.api.device.application.DeviceInfoEdit;
import com.whoz_in.main_api.command.api.device.application.DeviceInfoTempAdd;
import com.whoz_in.main_api.command.api.device.application.DeviceInfoTempAddRes;
import com.whoz_in.main_api.command.api.device.application.DeviceRegister;
import com.whoz_in.main_api.command.api.device.application.DeviceRemove;
import com.whoz_in.main_api.command.api.device.presentation.docs.DeviceCommandApi;
