package com.whoz_in.main_api.query.api.badge.presentatiion;

import com.whoz_in.main_api.query.api.badge.application.query.BadgeInfoGet;
import com.whoz_in.main_api.query.api.badge.application.query.MemberBadgeQuery;
import com.whoz_in.main_api.query.api.badge.application.query.RegistrableBadgeQuery;
import com.whoz_in.main_api.query.api.badge.application.view.BadgeInfo;
import com.whoz_in.main_api.query.api.badge.application.view.BadgesOfMember;
import com.whoz_in.main_api.query.api.badge.application.view.RegistrableBadges;
import com.whoz_in.main_api.query.api.badge.presentatiion.docs.BadgeQueryApi;
