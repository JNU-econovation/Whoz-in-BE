...
public class SorterTest {
    ...
    public void Active상태인_Member가_상위에_위치한다(){
        ...
        BadgeName badgeName = BadgeFixture.badgeName();

        // given
        List<MemberInRoomResponse> responses = new ArrayList<>(List.of(
                new MemberInRoomResponse(1, "1", "1", "1", "1", badgeName, 0, true),
                new MemberInRoomResponse(2, "2", "2", "2", "2",badgeName,0, false),
                new MemberInRoomResponse(3, "3", "3", "3", "3", badgeName,0, true),
                new MemberInRoomResponse(4, "4", "4", "4", "4",badgeName, 0, false)
        ));
    ...
    public void MemberName_기준_오름차순_정렬(){
        BadgeName badgeName = BadgeFixture.badgeName();
        List<MemberInRoomResponse> responses = new ArrayList<>(List.of(
            new MemberInRoomResponse(1, "1", "D", "1", "1", badgeName,0,true),
            new MemberInRoomResponse(2, "2", "C", "2", "2", badgeName,0,false),
            new MemberInRoomResponse(3, "3", "B", "3", "3", badgeName,0,true),
            new MemberInRoomResponse(4, "4", "A", "4", "4", badgeName,0,false)
        ));
